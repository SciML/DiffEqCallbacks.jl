...
# autodiff=false
cb_false =
    ManifoldProjection(g, nlsolve = DiffEqCallbacks.NLSOLVEJL_SETUP(autodiff = false))
...
cb_t_false =
    ManifoldProjection(g_t, nlsolve = DiffEqCallbacks.NLSOLVEJL_SETUP(autodiff = false))
